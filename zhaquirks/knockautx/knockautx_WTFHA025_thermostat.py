...
This Quirk manage basic information : temp, target temp, mode Off/Manual/Auto.
Unfortunately :
  ...
  - CVC (or "Action CVC" in HA with fr locale) should be the heating status but I was not able to test nor implement it ... yet
"""
